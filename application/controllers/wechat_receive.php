...
class Wechat_receive extends CI_Controller
{
    ...
    {
        //access_token
        $token = '14_m1D0WHsPOfohY_Ac-Upemf-nQ2Zo5iH6I9TwqfSfMYwVLRz7b_LXLcX2zKAf3oEw7y_-IQW3WBdALwXQaZmI3rHWKAGvVgWHrhYgmA-16ndXvC4_micIYry4vH84-HMFdMz9eWc1AY3yE2Y3EUKgAEAIYO';

        $url = "https://api.weixin.qq.com/cgi-bin/material/add_material?access_token=".$token."&type=image";
        //目录文件 /home/wwwroot/weixin.qsjet.com/0822.jpg
        $imageName = "/var/www/html/weixin/box1012.jpg";
...
class WeiXinTest
{
    public function responseMsg()
    {
        ...
        $dest = "您好，感谢您关注快舒尔！如果您的问题没有得到及时处理，您也可以选择拨打服务热线进行咨询：4000460899。祝您身体健康，事事如意。";
        //关键字回复
        if (strstr($Content, '注册')) {
            $dest = "您好，感谢您选择快舒尔无针注射器！目前，在快舒尔医疗公众号中完成产品注册就可以享受5年延保服务，延保条款参质保内容。进行产品注册，在“用户中心”中选择“产品注册”，根据提示内容填写产品注册码（产品注册码是16位纯数字，在产品外包装的背面，需要刮开涂层才能看到）等信息，填写完毕后，您还可以勾选“免费领取迅弥专用保护盒”，按提示填写收货信息即可。填写完毕后点击“提交”按钮，系统显示“注册成功”就说明您已经完成产品注册，获得5年延保服务，并且已经申请迅弥专用保护盒。祝您身体健康，事事如意。";
        } else if (strstr($Content, '延保')) {
            $dest = "您好，感谢您选择快舒尔无针注射器！目前，在快舒尔医疗公众号中完成产品注册就可以享受5年延保服务，延保条款参质保内容。进行产品注册，在“用户中心”中选择“产品注册”，根据提示内容填写产品注册码（产品注册码是16位纯数字，在产品外包装的背面，需要刮开涂层才能看到）等信息，填写完毕后，您还可以勾选“免费领取迅弥专用保护盒”，按提示填写收货信息即可。填写完毕后点击“提交”按钮，系统显示“注册成功”就说明您已经完成产品注册，获得5年延保服务，并且已经申请迅弥专用保护盒。祝您身体健康，事事如意。";
        } else if (strstr($Content, '保护盒')) {
            $dest = "您好，感谢您选择快舒尔无针注射器！迅弥专用保护盒会在快舒尔服务人员与您确认收货地址后2个工作日内为您免费发出，快递费用由快舒尔公司支付，您可以在“用户中心”中的“会员登录”板块中查看您的物流单号。祝您身体健康，事事如意。";
        }else if (strstr($Content, '发货')) {
            $dest = "您好，感谢您选择快舒尔无针注射器！迅弥专用保护盒会在快舒尔服务人员与您确认收货地址后2个工作日内为您免费发出，快递费用由快舒尔公司支付，您可以在“用户中心”中的“会员登录”板块中查看您的物流单号。祝您身体健康，事事如意。";
        }else if (strstr($Content, '价格')) {
            $dest = "您好，感谢您关注快舒尔无针注射器！您可以在您当地的经销商处了解相关的信息，如您不确定您所在地区有无经销商，您可以拨打4000460899来进行咨询。祝您身体健康，事事如意。";
        }else if (strstr($Content, '购买')) {
            $dest = "您好，感谢您关注快舒尔无针注射器！您可以在您当地的经销商处了解相关的信息，如您不确定您所在地区有无经销商，您可以拨打4000460899来进行咨询。祝您身体健康，事事如意。";
        }else if (strstr($Content, '买')) {
            $dest = "您好，感谢您关注快舒尔无针注射器！您可以在您当地的经销商处了解相关的信息，如您不确定您所在地区有无经销商，您可以拨打4000460899来进行咨询。祝您身体健康，事事如意。";
        }else if (strstr($Content, '多少钱')) {
            $dest = "您好，感谢您关注快舒尔无针注射器！您可以在您当地的经销商处了解相关的信息，如您不确定您所在地区有无经销商，您可以拨打4000460899来进行咨询。祝您身体健康，事事如意。";
       //关注公众号自动回复
        }else if (strtolower($obj->Event) == 'subscribe') {
            $dest = "欢迎您进入快舒尔医疗。\n快舒尔QS-P-01无针注射器隆重上市，\n完成注册即可享5年延保和专用保护盒。\n快快点击“用户中心”菜单中的“产品注册”领取吧！";
        }else if (strstr($Content, 'test1')) {
            $dest = "22";
...
<xml><ToUserName><![CDATA[%s]]></ToUserName><FromUserName><![CDATA[%s]]></FromUserName><CreateTime>%s</CreateTime><MsgType><![CDATA[%s]]></MsgType><Image><MediaId><![CDATA[%s]]></MediaId></Image></xml>";
            if ("connect" == $obj->EventKey) {
                ...
                $mediaId = "Q7h9DNH79WEsuYNJa_OP5iUHDmzVQgenQFowwLcgfm0";
                ...
                $mediaId = "Q7h9DNH79WEsuYNJa_OP5iq0GuuY3AQ5Y9aTbWCQWCY";
                $msg = "<xml><ToUserName><![CDATA[%s]]></ToUserName><FromUserName><![CDATA[%s]]></FromUserName><CreateTime>%s</CreateTime><MsgType><![CDATA[%s]]></MsgType><Image><MediaId><![CDATA[%s]]></MediaId></Image></xml>";
                echo sprintf($msg, $FromUserName, $ToUserName, $time, 'image', $mediaId);
                return;
            }
